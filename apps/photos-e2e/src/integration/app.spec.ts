...
describe('blog', () => {
  ...
  it('should open post', () => {
    ...
    cy.get("#root > div.w-full.h-full > div.post.w-full > div.post-content.w-full.max-w-screen-xl.mx-auto.-mt-12.relative > div > div.max-w-screen-xl.mx-auto.post-text > div.flex.flex-wrap.-mx-1.overflow-hidden > div:nth-child(1").click()
    // pwsp should have caption
    cy.get("div.pswp__caption").should('be.visible')
    // should close iamge
    cy.get('button.pswp__button--close').click()
