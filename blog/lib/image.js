...
const allPresets = presetList.concat([
  ...
  new Preset('coverimg', 2900, 500, '(max-width: 3000px)', 'jpeg'),
  new Preset('coverimgwebp', 2900, 500, '(max-width: 3000px)', 'webp'),
  new Preset('coverimgm', 1300, 300, '(max-width: 1300px)', 'jpeg'),
  new Preset('coverimgmwebp', 1300, 300, '(max-width: 1300px)', 'webp'),
